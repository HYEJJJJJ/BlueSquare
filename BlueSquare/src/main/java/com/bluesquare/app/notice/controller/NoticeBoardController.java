package com.bluesquare.app.notice.controller;
...
public class NoticeBoardController {
	...
	//게시글 수정
	@PostMapping("/modify")
	public String modify(NoticeBoardDto boardDto, RedirectAttributes rattr, Model m, HttpSession session) {
		...
		return "redirect:/notice/list";//주소를 이용하여 찾아가기
	...
	//게시글 작성
	@PostMapping("/write")
	public String write(NoticeBoardDto boardDto, RedirectAttributes rattr, Model m, HttpSession session, HttpServletRequest request) {
		if(!loginCheck(request))
			return "redirect:/login/login?toURL="+request.getRequestURL();
		String writer = (String) session.getAttribute("id");
	...
	public String read(Integer bno, Integer page, Integer pageSize, Model m) {
		...
		try {
			NoticeBoardDto boardDto = service.read(bno);
	...
	public String list(SearchCondition sc, Model m, HttpServletRequest request) {
		...
		List<NoticeBoardDto> list = service.getSearchSelectPage(sc);
